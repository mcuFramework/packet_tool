...
public class MakeFile {
    ...
    public static final String textHeaderStruct =
                    "/**\n" +
    ...
    public void makeStruct(){
        ...
        String stringHeader = textHeaderStruct;
        stringHeader = stringHeader.replace("%DEFINE-HEADER%", this.getTextHeader());
        stringHeader = stringHeader.replace("%NAMESPACE%", this.getNamespace("struct"));
    ...
    public void makeInterface(){
        ...
        stringHeader = stringHeader.replace("%DEFINE-HEADER%", this.getTextHeader());
        stringHeader = stringHeader.replace("%NAMESPACE%", this.getNamespace("interface"));
        stringHeader = stringHeader.replace("%PATH%", this.path);
        stringHeader = stringHeader.replace("%CLASS%", this.getClassName());
